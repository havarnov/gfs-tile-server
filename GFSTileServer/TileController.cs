...
public class TileController : ControllerBase
{
        ...
        CancellationToken cancellation = default)
    {
        ...
        var (xx, yy) = TileToLonLat(x, y, zoom);
    ...
    private static (double, double) TileToLonLat(int x, int y, int z)
    {
    ...
    internal struct TileGeometryTransform
    {
        ...
        public TileGeometryTransform(Tile tile, uint extent) : this()
        {
            _tile = tile;
            _extent = extent;
